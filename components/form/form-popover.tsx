...
import { useProModal } from "@/hooks/use-pro-modals";
...
export const FormPopover = ({
  ...
  const onSubmit = (formData: FormData) => {                // Al dar en submit recogemos el contenido del formulario    
    ...
    execute({ title, image })                               // Este title e image es la TInput data que se manda a execute del useAction -> action -> createBoard
